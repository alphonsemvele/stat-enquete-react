...
// ─── Widget & Embed (public, sans auth) ──────────────────────────────────────
Route::get('/widget.js',                  [EmbedController::class, 'widget'])->name('widget');
Route::get('/embed/{reference}',          [EmbedController::class, 'show'])  ->name('embed.show');
Route::post('/embed/{reference}/submit',  [EmbedController::class, 'submit'])->name('embed.submit');
...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    // ── Génération script embed ────────────────────────────────────────────────
    Route::get('/enquetes/{form}/script', [EmbedController::class, 'generateScript'])->name('embed.script');
    ...
    Route::prefix('contacts')->name('contacts.')->group(function () {
        ...
        Route::get('/template/excel',      [ContactController::class, 'templateExcel'])->name('template.excel');
        Route::get('/template/csv',        [ContactController::class, 'templateCsv']) ->name('template.csv');
...
// ─── Accepter / Refuser invitation équipe (public) ───────────────────────────
